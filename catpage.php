					...
					<div class="linux-section">
						<div class="container">
							<div class="linux-grids">
								...
								<?php
								$id = $_GET['id'];
								$res = $product->fetch_name($id);
								foreach ($res as $element)
								{
									?>
									<h2><?php echo $element['prod_name'] ?></h2>
							<?php		
								}
								?>
								...
								<ul>
									...
									<a class ="scrollTo" href="#myTabContent">view plans</a>
								</div>
							...
							<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
								...
								<div id="myTabContent" class="tab-content">
									<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                        ...
                                        <?php
										 $id = $_GET['id'];
                                        $result = $product->dynamic_table($id);
											...
											<div class="col-md-3 linux-price">
												...
												?>
                                              <h5><?php echo $item['mon_price']; ?><span class="month">per month</span></h5> 
                                              <h6><?php echo $item['prod_name']; ?></h6>		
													<ul>
                                                    <?php
												$result = json_decode($item['description']);
													?>
													<li><strong><?php echo $result->webspace;  ?></strong> Web Space</li>
													<li><strong><?php echo $result->bandwidth;  ?></strong> Bandwidth</li>
													<li><strong><?php echo $result->domain;  ?></strong> Domain</li>
													<li><strong><?php echo $result->language;  ?> </strong>  Language</li>
													<li><strong><?php echo $item['sku']; ?></strong>  SKU</li>
                                                    <li><strong><?php echo $item['prod_launch_date']; ?></strong>Lanuch Date</li>
													<li><strong>location</strong> : <img src="images/india.png"></li>
													</ul>
												</div>
												<a href="cart.php?id=<?php echo $item['id'] ?>">buy now</a>
											</div>
                                            <?php
											}
